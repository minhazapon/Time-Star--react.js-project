...
const Choose = () => {
    return (
        <div className=" mb-10 mt-10 ml-10 mr-10">
            ...
            <div className=" text-6xl font-serif  text-center"> 
	...
	<div className="container px-4 mx-auto">
		...
		<div className="flex flex-wrap items-stretch -mx-4">
			<div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8  bg-blue-950 ">
					...
					<button type="button" className="inline-block px-5 py-3 font-semibold tracking-wider text-center rounded  bg-black text-white  btn">Get Started</button>
				</div>
			</div>
			<div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-violet-600 text-gray-900">
					<div className="space-y-2">
			...
			<div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-black">
					<div className="space-y-2">
